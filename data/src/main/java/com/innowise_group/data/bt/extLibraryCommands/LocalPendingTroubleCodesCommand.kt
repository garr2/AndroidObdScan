...
class LocalPendingTroubleCodesCommand: PendingTroubleCodesCommand() {
    ...
    override fun performCalculations() {
        ...
        if (canOneFrameLength <= 16 && canOneFrameLength % 4 == 0) {//CAN(ISO-15765) protocol one frame.
            ...
            startIndex =
                    7//Header is xxx47yy, xxx is bytes of information to follow, yy showing the number of data items.
